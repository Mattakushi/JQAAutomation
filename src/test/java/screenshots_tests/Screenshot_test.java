...
public class Screenshot_test {
    ...
    public void shotScreen() throws IOException {
        ru.yandex.qatools.ashot.Screenshot actualScreenshot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(100)).takeScreenshot(driver);
        File actualFile = new File(absolutePath + "actualfullpagescreen.png");
        ImageIO.write(actualScreenshot.getImage(), "png", actualFile);

        ru.yandex.qatools.ashot.Screenshot expectedScreenshot = new ru.yandex.qatools.ashot.Screenshot(ImageIO.read(new File(absolutePath + "fullpagescreen.png")));
    ...
    public void elementScreenshot() throws IOException {
        ...
        ru.yandex.qatools.ashot.Screenshot actualScreenshot = new AShot().takeScreenshot(driver, header);
        File actualFile = new File(absolutePath + "element\\actualElement.png");
        ImageIO.write(actualScreenshot.getImage(), "png", actualFile);

        ru.yandex.qatools.ashot.Screenshot expectedScreenshot = new ru.yandex.qatools.ashot.Screenshot(ImageIO.read(new File(absolutePath + "element\\element.png")));
